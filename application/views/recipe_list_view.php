...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand" href="<?php echo site_url('main');?>">K &amp; N's | Recipe</a>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <a href="<?php echo site_url('recipe/add_new');?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add New Recipe</a>
                            <hr/>
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                             ...
                             <!-- <img src="<?php echo $row->recipe_image;?>"> -->
                                        <td>
                                            <a href="<?php echo site_url('recipe/get_edit/'.$row->recipe_id);?>" class="btn btn-sm btn-info"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
