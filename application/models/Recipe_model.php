...
class Recipe_model extends CI_Model{
	...
	function save_recipe($recipe_title,$category_id,$product_id,$recipe_serves,$recipe_preparation,$recipe_cooking,$recipe_ing,$recipe_method,$recipe_youtube,$recipe_image,$url_slug){
		$data = array(
	...
	function update_recipe($recipe_id,$recipe_title,$category_id,$product_id,$recipe_serves,$recipe_preparation,$recipe_cooking,$recipe_ing,$recipe_method,$recipe_youtube,$recipe_image,$url_slug){
    ...
    function get_recipe_by_url($url_slug = TRUE){

        $this->db->select('recipe_title,recipe_serves,recipe_preparation,recipe_cooking,recipe_youtube,recipe_image');
        $query = $this->db->get_where('recipe', array('url_slug' => $url_slug), 1);
        return $query;
    }
}